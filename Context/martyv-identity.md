...
Content is created and managed in the Notion Content Calendar. When a piece reaches the appropriate status trigger, it flows automatically to Buffer for scheduling across platforms.

Active scheduling tool: Buffer
Voice production tool: ElevenLabs (podcast and audio content)

---

## Brand Voice

Governed by `Context/personal-brand-identity.md`. All content across all platforms follows that voice specification. The voice file is the authority on how everything sounds.

## Brand Fingerprint

Visual identity, colour system, typography, production standards and quality gate are governed by `Context/Spheres/System/Entrepreneurship/Marty Gras/brand-fingerprint.md`. The fingerprint is the authority on how everything looks.
