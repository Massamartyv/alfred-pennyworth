...
# Reference Library – Marty Gras

A curated corpus of the creators, brands, works and curators that informs research, inspiration and creative direction for Marty Gras. Alfred draws on this library when a task needs a batch of grounded reference – what is working, what to extract, which canon to draw from – rather than reasoning from a blank page.

This library is isolated to Marty Gras. It never holds personal references or another venture's references.

## How Alfred uses it

1. A Marty Gras task calls for inspiration, creative direction or a research batch.
...
*Marty Gras Reference Library. Created 2026-06-21 under the Manor Protocol. Isolated from personal and from other ventures.*
