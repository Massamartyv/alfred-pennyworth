...
The Finances department owns revenue, costs, expenses, projections and the numbers that reveal the health of the venture. Finances tracks the signal in the numbers and surfaces what matters.

See venture-level `Agents/department-heads.md` for the Head of Finances role definition and full specialist seats.
...
|---|---|---|---|
| **Head of Finances** | Department head. Owns the numbers. | All | – |
...
Agent scratch space: `.working/{venture-slug}-finances/` (create on first use).
