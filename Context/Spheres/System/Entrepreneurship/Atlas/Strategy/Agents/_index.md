...
The Strategy studio owns industry research, competitive analysis, consumer behaviour and positioning. The thinking behind the work – what Creative builds, what Production develops and what Growth sells is informed here first.
...
Agent scratch space: `.working/{venture-slug}-strategy/` (create on first use).
