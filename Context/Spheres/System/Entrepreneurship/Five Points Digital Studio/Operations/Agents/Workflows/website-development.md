...
Full website build for a new or existing client. Operations' most complex build workflow – activates all five specialist roles and runs the complete Manor Protocol lifecycle. Cross-department workflow that receives direction from Marketing & Sales and Business Development and delivers to the client through Operations.
...
- Engagement scope defined by Marketing & Sales – which Website Engineering tier: Rapid, Custom or Platform
- Brand direction from Marketing & Sales – either completed brand-identity-build workflow output or existing client brand assets in `Brand Assets/`
...
- Review Marketing & Sales's brand direction output for technical implications – animation requirements, custom fonts, image-heavy layouts, video needs
...
**Cross-department input:** Business Development provides market research. Marketing & Sales provides brand direction if ready. Operations provides client brief.
...
- Fill all seven sections by synthesising Marketing & Sales's brand direction, the technical reconnaissance and Marketing & Sales's engagement scope:
  1. **Project Grounding and Objective** – from client brief and engagement scope
  2. **The Vision and "The Vibe"** – from Marketing & Sales's brand direction (aesthetic thesis, the tension, animation philosophy, visual references)
...
The PRD is the most consequential gate. It is the constitution for the entire build. Marketing & Sales's brand direction feeds in, but the PRD is Operations' document – it translates aesthetic intent into engineering specifications.
...
**Cross-department hand-off:** Once the preview URL is live, Marketing & Sales's Editor receives it for visual quality evaluation.
...
### Technical evaluation (QA Engineer)
...
### Visual evaluation (Editor, Marketing & Sales department)

Marketing & Sales's Editor evaluates the preview URL against Marketing & Sales's four criteria (`Marketing & Sales/Agents/Criteria/quality-rubric.md`):
...
- Visual critique report from Marketing & Sales's Editor – pass or fail per criterion with revision notes
...
1. **Marketing & Sales** closes the deal. Defines engagement scope and tier (Rapid, Custom or Platform). Hands off to Operations.
2. **Operations** onboards the client. Creates the client folder from template. Populates `Onboarding/client-brief.md`. Hands off to Business Development and Marketing & Sales in parallel.
3. **Business Development** runs competitive research and market positioning. Output goes to Marketing & Sales (for brand direction) and Operations (for technical reconnaissance).
4. **Marketing & Sales** runs the brand-identity-build or client-brand-direction workflow. Produces brand direction – visual identity, voice, content. Hands off to Operations.
5. **Operations** receives all of the above. Runs this workflow.
6. During Critique, **Marketing & Sales** receives the preview URL and runs its quality rubric evaluation. Returns visual critique report to Operations.
7. **Operations** runs its technical quality rubric evaluation. Both critique reports go to the human gate.
8. After Release, **Operations** delivers the production URL to the client and executes client handoff, running the project-handoff SOP when the client takes ownership.
