...
The six non-negotiable criteria that govern all build output from this department. Every build is evaluated against all six during the Critique phase. Failure on any single criterion sends the work back to Execution with specific revision notes.
