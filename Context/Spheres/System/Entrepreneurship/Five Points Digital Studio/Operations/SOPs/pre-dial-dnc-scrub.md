...
1. **Snapshot – monthly, on the 1st.** Download the area-code files to `Business Development/Prospecting/DNC Registry/` – gitignored, never committed – and record a ledger line: date, area codes, row counts. A snapshot older than 31 days is expired and blocks all dialing.
