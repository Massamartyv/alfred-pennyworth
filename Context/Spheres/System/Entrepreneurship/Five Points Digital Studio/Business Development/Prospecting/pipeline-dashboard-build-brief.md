...
1. `Business Development/Prospecting/lookalike-engine.md` — the outreach engine, two-stage funnel (Connect → Convert), run log through Pulse 6.
2. `Business Development/Prospecting/outreach-log.md` — touch-1 sends (70 on 2026-06-30) and Stage-A connection requests (19 on 2026-07-01).
...
1. **Scaffold.** Create `Business Development/Prospecting/pipeline-sync/` in the venture folder: `README.md`, `schema.json` (the table above as code), `.env` reference (`NOTION_FIVEPOINTS_TOKEN` — never hardcode).
