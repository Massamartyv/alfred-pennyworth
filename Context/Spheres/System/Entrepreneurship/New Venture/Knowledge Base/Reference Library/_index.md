...
# Reference Library – {Venture Name}

A curated corpus of the creators, brands, works and curators that informs research, inspiration and creative direction for {Venture Name}. Alfred draws on this library when a task needs a batch of grounded reference – what is working, what to extract, which canon to draw from – rather than reasoning from a blank page.

This library is isolated to {Venture Name}. It never holds personal references or another venture's references.

## How Alfred uses it

1. A {Venture Name} task calls for inspiration, creative direction or a research batch.
...
├── Creators/      – individuals: founders, practitioners, designers, writers, photographers relevant to the venture's domain
├── Brands/        – companies, analogues, competitors and category-defining brands to draw from or define against
├── Works/         – specific pieces: campaigns, products, case studies, publications, cultural moments
├── Curators/      – tastemaker contexts: publications, editorial communities, industry bodies, scenes
...
*{Venture Name} Reference Library. Created 2026-06-21 under the Manor Protocol. Isolated from personal and from other ventures.*
