...
# Reference Library – Athena

A curated corpus of the creators, brands, works and curators that informs research, inspiration and creative direction for Athena. Alfred draws on this library when a task needs a batch of grounded reference – what is working, what to extract, which canon to draw from – rather than reasoning from a blank page.

This library is isolated to Athena. It never holds personal references or another venture's references.

## How Alfred uses it

1. An Athena task calls for inspiration, creative direction or a research batch.
...
├── Creators/      – individuals: agency founders, creative directors, talent scouts, photographers, stylists, casting directors
├── Brands/        – talent agencies, model management houses, creator economy platforms, analogues and competitors to draw from or define against
├── Works/         – specific pieces: campaigns, editorial spreads, talent-led products, cultural moments, case studies of transformative bookings
├── Curators/      – tastemaker contexts: industry publications, fashion weeks, casting communities, creator economy editorial
...
The extraction sweep populates this registry.
...
*Athena Reference Library. Created 2026-06-21 under the Manor Protocol. Isolated from personal and from other ventures.*
