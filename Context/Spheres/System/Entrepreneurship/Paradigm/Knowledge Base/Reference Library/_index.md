...
# Reference Library – Paradigm

A curated corpus of the creators, brands, works and curators that informs research, inspiration and creative direction for Paradigm. Alfred draws on this library when a task needs a batch of grounded reference – what is working, what to extract, which canon to draw from – rather than reasoning from a blank page.

This library is isolated to Paradigm. It never holds personal references or another venture's references.

## How Alfred uses it

1. A Paradigm task calls for inspiration, creative direction or a research batch.
...
├── Creators/      – individuals: founders, formulators, creative directors, wellness practitioners, photographers
├── Brands/        – wellness and health brands, analogues, competitors and category-defining companies to draw from or define against
├── Works/         – specific pieces: campaigns, product launches, editorial spreads, packaging designs, case studies
├── Curators/      – tastemaker contexts: wellness publications, retail buyers, ingredient communities, movements
...
|---|---|---|---|---|---|
| Equinox | brand | luxury-fitness, premium-wellness, aspirational-belonging, brand-design | register-anchor, aspirational-status, belonging, positioning, proposition, offer-design, spatial-direction, visual-direction | canon | [Brands/equinox.md](Brands/equinox.md) |
| Alo Yoga | brand | premium-activewear, wellness-lifestyle, ecosystem-design | offer-design, proposition, ecosystem-model, product-method-space, merchandising | watch | [Brands/alo-yoga.md](Brands/alo-yoga.md) |
| Arc'teryx | brand | outdoor-performance-apparel, material-innovation, premium-technical-design | materiality, offer-design, proposition, restraint | watch | [Brands/arcteryx.md](Brands/arcteryx.md) |
| Life Time Fitness | brand | premium-fitness-clubs, destination-wellness, experiential-health | spatial-direction, offer-design, hospitality, proposition | watch | [Brands/life-time-fitness.md](Brands/life-time-fitness.md) |
...
*Paradigm Reference Library. Created 2026-06-21 under the Manor Protocol. Isolated from personal and from other ventures.*
