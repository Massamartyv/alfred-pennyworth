...
The Production studio is the execution engine. Formulations, manufacturing coordination, packaging production and content production live here. Everything the brand puts into the world is built through this studio.
...
A single content shoot engages only the Content Producer and Quality Assurance. A new product launch activates the full roster.
...
Agent scratch space: `.working/paradigm-production/` (create on first use).
