...
A routine trademark monitoring sweep engages only the Brand Protection Lead. A product launch pulls Regulatory Compliance and Legal together for claims review and manufacturer terms.
...
Agent scratch space: `.working/paradigm-administration/` (create on first use).
