...
- Swimming: baseline to be established
- Cycling: baseline to be established

**Endurance data sources:** Strava (primary detailed tracking), Apple Health (synced from Apple Watch), Fitness Journal in Notion (summary log)
