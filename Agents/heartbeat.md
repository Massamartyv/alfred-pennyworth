...
| First of every month | Counting House monthly close | Close the prior month in the Notion Finance Manager: reconcile every account, clear the uncategorised queue to zero, record the close row, review the subscription stack and cull one thing. Read the six tripwires and act on any red before the session ends. Ceiling is one pomodoro – if it runs longer the instrument has grown past its remit. Doctrine: `Context/Spheres/System/Personal Finance/counting-house.md`. |
...
*Last updated: 2026-09-07 – Counting House monthly close registered, taking up the personal finance cadence the deleted Finance Dashboard never carried.*
