...
| Weekly, Monday morning | Portfolio briefing | Aggregates tasks, projects, content pipeline and Five Points revenue into one briefing. Delivered via iMessage. Scheduled task: `penny-one`. |
...
*Last updated: 2026-06-11 – Watchtower, portfolio briefing and quarterly restore drill added; table now mirrors the full scheduled-task registry.*
